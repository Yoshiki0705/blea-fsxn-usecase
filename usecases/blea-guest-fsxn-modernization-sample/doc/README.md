# BLEA Guest System: FSx for ONTAP Modernization Platform
...
> **ECS Fargate Note**: Fargate **cannot** mount FSx for ONTAP NFS directly. Data is accessed via S3 Access Point. If POSIX file operations are required, use the EC2 pattern instead.
...
| Metric | Before (VMware) | After (AWS + FSx for ONTAP) |
|--------|-----------------|-------------------|
