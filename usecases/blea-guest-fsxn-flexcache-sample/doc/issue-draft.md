...
├── FSx for ONTAP (Multi-AZ, authoritative)      ├── FSx for ONTAP (Single/Multi-AZ)
...
- **Dual-FSx for ONTAP architecture** with VPC Peering (same-region) or Transit Gateway (cross-region)
