# BLEA Guest System: FSx for ONTAP FlexCache Distributed Access Acceleration
...
│  FSx for ONTAP (Multi-AZ)     │  TCP 11104   │  FSx for ONTAP (Single-AZ)   │
...
2. FSx for ONTAP admin password stored in Secrets Manager
